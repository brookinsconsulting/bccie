...
{* <h1>{$Collections.contentobject_id|attribute(show,1)}</h1><hr /> *}
...
<br /><br />
<form name="exportCollection" method="post" action={concat( '/bccie/export/', $object.id )|ezurl}>
<input class="button" type="submit" name="exportCollectionButton" value="{'Export Collection'|i18n( 'design/bccie/collectionlist' )}" title="{'Export selected collection.'|i18n( 'design/bccie/collectionlist' )}" />
{else}
...
<br /><br />
<form name="exportCollection" method="post" action={concat( '/bccie/export/', $object.id )|ezurl}>
<input class="button-disabled" type="submit" name="exportCollectionButton" value="{'Export Collection'|i18n( 'design/bccie/collectionlist' )}" title="{'Export selected collection.'|i18n( 'design/bccie/collectionlist' )}" disabled="disabled" />
{/if}
</div>
